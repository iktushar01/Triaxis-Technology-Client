  ...
  const aiProducts = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1677442135136-760c813cd9f2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80",
      badge: "Best Seller",
    },
    {
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              Cutting-edge artificial intelligence products that transform data
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            >
              ...
              <p className="text-xl text-red-100 mb-6">
                Our AI specialists can tailor solutions to your specific
